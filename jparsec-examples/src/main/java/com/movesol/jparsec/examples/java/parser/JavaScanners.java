...
import static com.movesol.jparsec.pattern.Patterns.*;

import com.movesol.jparsec.Parser;
import com.movesol.jparsec.pattern.CharPredicates;
import com.movesol.jparsec.pattern.Pattern;
...
public class JavaScanners {
  ...
  /**
   * A {@link com.movesol.jparsec.pattern.Pattern} object that matches an octal integer that starts with a {@code 0} and is followed by 1 or more
