 ...
 * @author Ben Yu
 */
final public class CharSequenceSourceLocator implements SourceLocator {
  ...
  /**
   * Creates a {@link CharSequenceSourceLocator} object.
   * 
   * @param source the source.
   */  
  public CharSequenceSourceLocator(CharSequence source) {
    this(source, 1, 1);
  }
   ...
   */
  @Private CharSequenceSourceLocator(CharSequence source, int lineNumber, int columnNumber) {
    this.source = source;
